          ...
          <div className="bg-light shadow-sm rounded p-3 p-sm-4 mb-4">
            ...
            <form id="form-send-money" method="post">
              <div className="form-group">
                ...
                <input type="text" value="" className="form-control" data-bv-field="payerName" id="payerName" required placeholder="Enter Name"/>
              </div>
              <div className="form-group">
                <label for="emailID">Email</label>
                <input type="text" value="" className="form-control" data-bv-field="emailid" id="emailID" required placeholder="Enter Email Address"/>
              </div>
              <div className="form-group">
              ...
              <div className="form-group">
                ...
                <div className="input-group">
                  ...
                  <input type="text" className="form-control" data-bv-field="amount" id="amount" value="1,000.00" placeholder=""/>
              ...
              <div className="form-group">
                ...
                <div className="position-relative">
                  <input id="paymentDue" value="" type="text" className="form-control" required placeholder="Payment Due Date"/>
                  <span className="icon-inside"><i className="fas fa-calendar-alt"></i></span> </div>
              </div>
              <Button 
                onClick={()=>{console.log('butn-clicked==='); this.props.history.push('/request-money-confirm')}}
                className="btn btn-primary btn-block mt-4">Continue</Button>
            </form>
          </div>
        </div>
      </div>
