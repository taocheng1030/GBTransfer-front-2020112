...
class LandingPageFee extends Component {
    ...
    getBalance(){
      ...
      api.getMyWallet((error,res)=>{
        console.log("error,res on getbalance==",error,res)
        if(error){return}
    ...
    refreshProfile(){
      var savedUser = JSON.parse(localStorage.currentUser)
        ...
        api.getUser(savedUser.user.id,(error,res)=>{
          console.log('res on refresh0000==>',res)
          this.setState({loading:false})
          if(error){
              return
          }
    ...
    photoUpload(e){
        console.log('e on uploadPhoto====',e)
        let {currentUser}=this.state
        this.setState({imageLoading:true})
        api.photoUpload(e.target.files[0],(error,res)=>{
              this.setState({imageLoading:false})
              if(error){
                return
              }
              this.setState({image:res.path},()=>{
                   currentUser.user.image = res.path
                   this.updateProfile()
              })
        })     
    }
    ...
    updateProfile() {
      ...
      // this.props.update(this.state.username, this.state.image)
      api.updateProfile({
          data: {
    ...
    render(){
      let {currentUser,imageLoading,usdBalance,euroBalance,gbpBalance} = this.state
      console.log('profiles----currentUser.user.image----', currentUser)
        ...
        return(
              ...
              <div className="row"> 
                <aside className="col-lg-3"> 
                  <div className="bg-light shadow-sm rounded text-center p-3 mb-4">
                    <div className="profile-thumb mt-3 mb-4">
                       {
                         imageLoading ? <Loader type="Oval" color="grey" height={20} width={20} />:
                        // <img className="rounded-circle" src={currentUser.user.image} style={{width:90,height:90}} alt=""/>
                        (currentUser&&currentUser.user&&currentUser.user.image) ? <img className="rounded-circle" src={(!!currentUser) && currentUser.user.image} style={{ width: 90, height: 90 }} alt="" /> : <i className="text-20 text-light fas fa-user-circle" ></i>
                       }
                      <div className="profile-thumb-edit custom-file bg-primary text-white" data-toggle="tooltip" title="Change Profile Picture"> <i className="fas fa-camera position-absolute"></i>
                        <input type="file" className="custom-file-input" id="customFile" onChange={this.photoUpload.bind(this)}/>
                      </div>
                    </div>
                    <p className="text-3 font-weight-500 mb-2">Hello, {currentUser&&currentUser.user&&currentUser.user.name}</p>
                    {/* <p className="mb-2"><a className="text-5 text-light" data-toggle="tooltip" title="Edit Profile"><i className="fas fa-edit"></i></a></p> */}
                  </div>
                  <div className="bg-light shadow-sm rounded text-center p-3 mb-4">
                ...
                <div className="col-lg-9">
                  <div className="bg-light shadow-sm rounded p-4 mb-4">
                    <h3 className="text-5 font-weight-400 mb-3">Personal Details 
                      <a  onClick={()=>{this.refs.edit_modal.openModal()}} data-toggle="modal" className=" click-able float-right text-1 text-uppercase text-muted btn-link"><i className="fas fa-edit mr-1"></i>Edit</a>
                    </h3>
                    <div className="row">
                      <p className="col-sm-3 text-muted text-sm-right mb-0 mb-sm-3">Name</p>
                      <p className="col-sm-9">{currentUser&&currentUser.user&&currentUser.user.name}</p>
                    </div>
                    <div className="row">
                      <p className="col-sm-3 text-muted text-sm-right mb-0 mb-sm-3">Address</p>
                      <p className="col-sm-9">{currentUser&&currentUser.user&&currentUser.user.address}<br/>
                        {/* San Ditego,<br/>
                        California - 22434,<br/> */}
                        {currentUser&&currentUser.user&&currentUser.user.country}</p>
                    </div>
                  </div>
                            ...
                            <div className="row">
                              ...
                              <div className="col-12">
                                <div className="form-group">
                                  ...
                                  <input type="text" value="4th Floor, Plot No.22, Above Public Park" className="form-control" data-bv-field="address" id="address" required placeholder="Address 1"/>
                                </div>
                              </div>
                              <div className="col-12 col-sm-6">
                                <div className="form-group">
                                  <label for="city">City</label>
                                  <input id="city" value="San Ditego" type="text" className="form-control" required placeholder="City"/>
                                </div>
                              </div>
                              <div className="col-12 col-sm-6">
                                <div className="form-group">
                              ...
                              <div className="col-12 col-sm-6">
                                <div className="form-group">
                                  ...
                                  <input id="zipCode" value="22434" type="text" className="form-control" required placeholder="City"/>
                                </div>
                              </div>
                              <div className="col-12 col-sm-6">
                                <div className="form-group">
                  ...
                  {/* <div className="bg-light shadow-sm rounded p-4 mb-4">
                    <h3 className="text-5 font-weight-400 mb-3">Account Settings <a  onClick={()=>{this.refs.edit_modal.openModal()}}  data-toggle="modal" className="click=able float-right text-1 text-uppercase text-muted btn-link"><i className="fas fa-edit mr-1"></i>Edit</a></h3>
                    <div className="row">
                    ...
                    <div className="row">
                      ...
                      <p className="col-sm-9"><span className="bg-success text-white rounded-pill d-inline-block px-2 mb-0"><i className="fas fa-check-circle"></i> Active</span></p>
                    </div>
                  </div> */}
                  ...
                  <div className="bg-light shadow-sm rounded p-4 mb-4">
                    <h3 className="text-5 font-weight-400 mb-3">Email Addresses 
                      {/* <a  onClick={()=>{this.refs.edit_modal.openModal()}}  data-toggle="modal" className="click-able float-right text-1 text-uppercase text-muted btn-link"><i className="fas fa-edit mr-1"></i>Edit</a> */}
                    </h3>
                    <div className="row">
                      ...
                      <p className="col-sm-9">{currentUser.user.email}</p>
                    </div>
                  </div>
                      ...
                      <div className="modal-content">
                        ...
                        <div className="modal-body p-4">
                          <form id="emailAddresses" method="post">
                            ...
                            <a className="btn-link text-uppercase d-flex align-items-center text-1 float-right mb-3" href="#"><span className="text-3 mr-1"><i className="fas fa-plus-circle"></i></span>Add another email</a>
                  ...
                  <div className="bg-light shadow-sm rounded p-4 mb-4">
                    <h3 className="text-5 font-weight-400 mb-3">Phone 
                      {/* <a  onClick={()=>{this.refs.edit_modal.openModal()}}  data-toggle="modal" className="click-able float-right text-1 text-uppercase text-muted btn-link"><i className="fas fa-edit mr-1"></i>Edit</a> */}
                    </h3>
                    <div className="row">
                      ...
                      <p className="col-sm-9">{currentUser.user.phone}</p>
                    </div>
                  </div>
                      ...
                      <div className="modal-content">
                        ...
                        <div className="modal-body p-4">
                          <form id="phone" method="post">
                            ...
                            <a className="btn-link text-uppercase d-flex align-items-center text-1 float-right mb-3" href="#"><span className="text-3 mr-1"><i className="fas fa-plus-circle"></i></span>Add another Phone</a>
                            <button className="btn btn-primary btn-block" type="submit">Save Changes</button>
                          </form>
                        </div>
                      </div>
                  ...
                  <div className="bg-light shadow-sm rounded p-4">
                    <h3 className="text-5 font-weight-400 mb-3">Security 
                      <a  onClick={()=>{this.refs.password_edit_modal.openModal()}}  data-toggle="modal" className="click-able float-right text-1 text-uppercase text-muted btn-link"><i className="fas fa-edit mr-1"></i>Edit</a>
                    </h3>
                    {/* <h3 className="text-5 font-weight-400 mb-3">Security <a  onClick={()=>{this.refs.edit_modal.openModal()}}  data-toggle="modal" className="click-able float-right text-1 text-uppercase text-muted btn-link"><i className="fas fa-edit mr-1"></i>Edit</a></h3> */}
                    <div className="row">
            ...
            />
            <PasswordEditModal 
                ref="password_edit_modal" 
                currentUser={currentUser}
                refreshProfile={()=>{this.refreshProfile()}}
            />
            
            {/* <EditModal ref="edit_modal"/> */}
          </div>
        )
    }
}
