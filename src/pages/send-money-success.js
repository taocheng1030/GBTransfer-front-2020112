          ...
          <div className="row">
            <div className="col-md-8 col-lg-6 col-xl-5 mx-auto">
              <div className="bg-light shadow-sm rounded p-3 p-sm-4 mb-4">
                ...
                <p className="text-center text-3 mb-4">You've Succesfully sent <span className="text-4 font-weight-500">{result.amount.toFixed(2)} {result.fromCurrency}</span> to <span className="font-weight-500">{user.label}</span>, See transaction details under <a href="/transactions">Activity</a>.</p>
                <p className="text-center text-3 mb-4">Or you can check your transaction in <br /><a href={`http://bluebarricade-blockchain-explorer.s3-website.us-east-2.amazonaws.com
